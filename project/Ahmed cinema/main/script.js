...
let cards = [
    ...
    {
        background:
            "https://e1.pxfuel.com/desktop-wallpaper/171/608/desktop-wallpaper-batman-the-dark-knight.jpg",
    ...
    {
        background:
            "https://bronaghdoc10.files.wordpress.com/2014/12/img_2419.jpg",
        display_background:
            "//external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fhdqwalls.com%2Fdownload%2Finterstellar-gargantua-u4-1920x1080.jpg&f=1&nofb=1",
        title: "WALL•E",
        description:
            "WALL•E (Waste Allocation Load Lifter Earth-Class) is the last robot left on Earth, programmed to clean up the planet, one trash cube at a time. However, after 700 years, he's developed one little glitch—a personality."
    },
    {
        background:
    ...
    {
        background:
            "https://thesunflower.com/wp-content/uploads/2023/01/02-pib-dm-mobile-banner-1080x745-km-f01-061422-62a9f2d372f3a-1-900x621.jpg",
        display_background:
            "//external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fhdqwalls.com%2Fdownload%2Finterstellar-gargantua-u4-1920x1080.jpg&f=1&nofb=1",
        title: "Puss In Boots",
        description:
            " a European fairy tale about an anthropomorphic cat who uses trickery and deceit to gain power, wealth, and the hand in marriage of a princess for his penniless and low-born master."
    },
    {
        background:
